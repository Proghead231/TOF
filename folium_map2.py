...
DATA_URL = (path+"/Municipality_level_TOF_Forest.csv")
#app_path = "/Proghead231/TOF/Bagmati_TOF"
#File path for the boundaries
input_folder = (path+"/Bagmati_Municipalities.shp")
...
data = pd.read_csv(path+"/merged_csv.csv")
...
duplicated_row = raw_data[raw_data.duplicated(['municipality'])]
st.write("duplicated rows in all cols")
st.write(duplicated_row)
